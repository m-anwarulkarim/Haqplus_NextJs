...
export default function WishlistPage() {
  ...
  // Fetch products from API for wishlist display
    ...
    async function fetchProducts() {
      try {
        ...
        if (res.ok) {
          ...
          if (data.products) setWishlistProducts(data.products.slice(0, 3));
        }
      } catch (err) {
    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">আপনার সংরক্ষিত প্রিয় সব অর্গানিক চা পাতা</p>
        </div>
      </div>
      ...
      {wishlistProducts.length === 0 ? (
        <Card className="p-12 text-center border-dashed">
          ...
          <p className="text-sm text-muted-foreground max-w-sm mx-auto mb-6">
            পছন্দের তালিকায় এখনো কোনো চা যোগ করা হয়নি। শপে ঘুরে আপনার পছন্দের চা সেভ করুন!
          </p>
