  ...
  try {
    ...
    const templates = {
      ...
      EMAIL_ORDER_PENDING_SUBJECT:
        settings.EMAIL_ORDER_PENDING_SUBJECT || DEFAULT_EMAIL_TEMPLATES.ORDER_PENDING_SUBJECT,
      EMAIL_ORDER_PENDING_BODY:
        settings.EMAIL_ORDER_PENDING_BODY || DEFAULT_EMAIL_TEMPLATES.ORDER_PENDING_BODY,
      ...
      EMAIL_ORDER_PROCESSING_SUBJECT:
        settings.EMAIL_ORDER_PROCESSING_SUBJECT || DEFAULT_EMAIL_TEMPLATES.ORDER_PROCESSING_SUBJECT,
      EMAIL_ORDER_PROCESSING_BODY:
        settings.EMAIL_ORDER_PROCESSING_BODY || DEFAULT_EMAIL_TEMPLATES.ORDER_PROCESSING_BODY,
      ...
      EMAIL_ORDER_RETURNED_SUBJECT:
        settings.EMAIL_ORDER_RETURNED_SUBJECT || DEFAULT_EMAIL_TEMPLATES.ORDER_RETURNED_SUBJECT,
      EMAIL_ORDER_RETURNED_BODY:
        settings.EMAIL_ORDER_RETURNED_BODY || DEFAULT_EMAIL_TEMPLATES.ORDER_RETURNED_BODY,
    };
